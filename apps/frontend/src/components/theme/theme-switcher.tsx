...
export function ThemeSwitcher({ compact = false }: { compact?: boolean }) {
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,176,83,0.2),rgba(255,106,46,0.14)_42%,transparent_72%)] opacity-80 transition-opacity duration-200 group-hover:opacity-100" />
